...
#define FFMPEG_CONFIGURATION "--logfile=conflog.txt --target-os=android --prefix=/Users/luoye/Git/Github/ffmpeg-android-build/build/ffmpeg/android/arm64-v8a --enable-small --enable-cross-compile --extra-libs=-lgcc --arch=aarch64 --cc=/Volumes/Data/Git/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android-gcc --cross-prefix=/Volumes/Data/Git/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android- --nm=/Volumes/Data/Git/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android-nm --extra-cflags=-I/Users/luoye/Git/Github/ffmpeg-android-build/build/x264/android/arm64/include --extra-ldflags=-L/Users/luoye/Git/Github/ffmpeg-android-build/build/x264/android/arm64/lib --sysroot=/Volumes/Data/Git/android-ndk-r14b/platforms/android-21/arch-arm64/ --extra-cflags= --extra-ldflags='-lx264 -Wl,-rpath-link=/Volumes/Data/Git/android-ndk-r14b/platforms/android-21/arch-arm64//usr/lib -L/Volumes/Data/Git/android-ndk-r14b/platforms/android-21/arch-arm64//usr/lib -nostdlib -lc -lm -ldl -llog' --enable-static --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=concat --disable-parsers --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=image2 --enable-demuxer=gif --disable-decoders --enable-decoder=aac --enable-decoder=png --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=gif --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=mp3 --enable-muxer=ipod --enable-muxer=gif --disable-encoders --enable-encoder=aac --enable-encoder=libx264 --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=gif --enable-swscale --disable-filters --enable-filter=crop --enable-filter=scale --enable-filter=afade --enable-filter=copy --enable-filter=aformat --enable-filter=overlay --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=volume --enable-filter=rotate --enable-filter=apad --enable-filter=amerge --enable-filter=aresample --enable-filter=setpts --enable-filter=fps --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=trim --enable-filter=null --enable-filter=overlay --enable-filter=format --enable-filter=atrim --enable-filter=split --enable-filter=amix --enable-filter=anull --enable-filter=adelay --enable-gpl --enable-zlib --enable-libx264 --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --enable-decoder=mpeg4_mediacodec --enable-decoder=vp9_mediacodec --enable-decoder=vp8_mediacodec --enable-decoder=hevc_mediacodec --enable-hwaccels --enable-hwaccel=h264_mediacodec --enable-hwaccel=vp8_mediacodec --enable-hwaccel=vp9_mediacodec --enable-hwaccel=mpeg4_mediacodec --enable-hwaccel=hevc_mediacodec --enable-asm --enable-version3"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/Users/luoye/Git/Github/ffmpeg-android-build/build/ffmpeg/android/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/luoye/Git/Github/ffmpeg-android-build/build/ffmpeg/android/arm64-v8a/share/ffmpeg"

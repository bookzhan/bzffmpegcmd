...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=/Users/guaishou/Git/Github/ffmpeg-android-build/build/ffmpeg/android/armeabi-v7a --enable-small --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/Users/guaishou/Git/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/Users/guaishou/Git/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --nm=/Users/guaishou/Git/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-nm --sysroot=/Users/guaishou/Git/ndk/android-ndk-r14b/platforms/android-14/arch-arm/ --extra-cflags='-DANDROID -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300' --extra-ldflags='-Wl,-rpath-link=/Users/guaishou/Git/ndk/android-ndk-r14b/platforms/android-14/arch-arm//usr/lib -L/Users/guaishou/Git/ndk/android-ndk-r14b/platforms/android-14/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog' --enable-static --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --disable-postproc --enable-protocol=file --enable-protocol=concat --disable-parsers --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=image2 --enable-demuxer=gif --enable-demuxer=wav --enable-demuxer=asf --enable-demuxer=flv --enable-demuxer=avi --enable-demuxer=mpegts --disable-decoders --enable-decoder=aac --enable-decoder=png --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=gif --enable-decoder=hevc --disable-muxers --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=ipod --enable-muxer=gif --disable-encoders --enable-encoder=aac --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=mpeg4 --enable-encoder=gif --enable-swscale --disable-filters --enable-filter=crop --enable-filter=scale --enable-filter=afade --enable-filter=atempo --enable-filter=copy --enable-filter=aformat --enable-filter=overlay --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=volume --enable-filter=rotate --enable-filter=apad --enable-filter=amerge --enable-filter=aresample --enable-filter=setpts --enable-filter=fps --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=trim --enable-filter=null --enable-filter=overlay --enable-filter=format --enable-filter=atrim --enable-filter=split --enable-filter=amix --enable-filter=anull --enable-filter=adelay --disable-gpl --enable-zlib --enable-jni --enable-nonfree --enable-mediacodec --enable-asm --enable-version3 --disable-doc --enable-neon"

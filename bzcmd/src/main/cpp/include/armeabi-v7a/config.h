...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=/Users/guaishou/Git/Github/ffmpeg-android-build/build/ffmpeg/android/armeabi-v7a --enable-small --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/Users/guaishou/Git/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/Users/guaishou/Git/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --nm=/Users/guaishou/Git/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-nm --extra-cflags=-I/Users/guaishou/Git/Github/ffmpeg-android-build/build/x264/android/arm/include --extra-ldflags=-L/Users/guaishou/Git/Github/ffmpeg-android-build/build/x264/android/arm/lib --extra-cflags=-I/Users/guaishou/Git/Github/ffmpeg-android-build/build/../mp3lame/include --extra-ldflags=-L/Users/guaishou/Git/Github/ffmpeg-android-build/build/mp3lame/local/armeabi-v7a --sysroot=/Users/guaishou/Git/ndk/android-ndk-r14b/platforms/android-14/arch-arm/ --extra-cflags='-DANDROID -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300' --extra-ldflags='-Wl,-rpath-link=/Users/guaishou/Git/ndk/android-ndk-r14b/platforms/android-14/arch-arm//usr/lib -L/Users/guaishou/Git/ndk/android-ndk-r14b/platforms/android-14/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog' --enable-static --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=concat --disable-parsers --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=image2 --enable-demuxer=gif --enable-demuxer=wav --enable-demuxer=asf --enable-demuxer=flv --enable-demuxer=avi --enable-demuxer=webm_dash_manifest --enable-demuxer=matroska --disable-decoders --enable-decoder=aac --enable-decoder=png --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=gif --enable-decoder=pcm_s16le --enable-decoder=hevc --enable-decoder=msmpeg4v1 --enable-decoder=msmpeg4v2 --enable-decoder=msmpeg4v3 --enable-decoder=wmav1 --enable-decoder=wmav2 --enable-decoder=flv --enable-decoder=adpcm_swf --enable-decoder=ac3 --enable-decoder=vp8 --enable-decoder=vorbis --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=mp3 --enable-muxer=ipod --enable-muxer=gif --disable-encoders --enable-encoder=aac --enable-encoder=libx264 --enable-encoder=png --enable-encoder=libmp3lame --enable-encoder=mjpeg --enable-encoder=gif --enable-swscale --disable-filters --enable-filter=crop --enable-filter=scale --enable-filter=afade --enable-filter=atempo --enable-filter=copy --enable-filter=aformat --enable-filter=overlay --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=volume --enable-filter=rotate --enable-filter=apad --enable-filter=amerge --enable-filter=aresample --enable-filter=setpts --enable-filter=fps --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=trim --enable-filter=null --enable-filter=overlay --enable-filter=format --enable-filter=atrim --enable-filter=split --enable-filter=amix --enable-filter=anull --enable-filter=adelay --enable-gpl --enable-zlib --enable-libx264 --enable-libmp3lame --enable-jni --enable-nonfree --enable-mediacodec --enable-decoder=h264_mediacodec --enable-decoder=mpeg4_mediacodec --enable-decoder=vp9_mediacodec --enable-decoder=vp8_mediacodec --enable-decoder=hevc_mediacodec --enable-hwaccels --enable-asm --enable-version3 --disable-doc --enable-neon"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/Users/guaishou/Git/Github/ffmpeg-android-build/build/ffmpeg/android/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/guaishou/Git/Github/ffmpeg-android-build/build/ffmpeg/android/armeabi-v7a/share/ffmpeg"
...
#define CONFIG_MPEG2_MEDIACODEC_HWACCEL 1

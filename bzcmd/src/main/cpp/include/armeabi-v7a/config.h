...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=/Users/guaishou/Git/Github/ffmpeg-android-build/build/ffmpeg/android/armeabi-v7a --enable-small --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/Volumes/Data/Git/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/Volumes/Data/Git/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --nm=/Volumes/Data/Git/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-nm --extra-cflags=-I/Users/guaishou/Git/Github/ffmpeg-android-build/build/x264/android/arm/include --extra-ldflags=-L/Users/guaishou/Git/Github/ffmpeg-android-build/build/x264/android/arm/lib --sysroot=/Volumes/Data/Git/android-ndk-r14b/platforms/android-14/arch-arm/ --extra-cflags='-DANDROID -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300' --extra-ldflags='-Wl,-rpath-link=/Volumes/Data/Git/android-ndk-r14b/platforms/android-14/arch-arm//usr/lib -L/Volumes/Data/Git/android-ndk-r14b/platforms/android-14/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog' --enable-static --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=concat --disable-parsers --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=image2 --enable-demuxer=gif --enable-demuxer=wav --disable-decoders --enable-decoder=aac --enable-decoder=png --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=gif --enable-decoder=pcm_s16le --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=mp3 --enable-muxer=ipod --enable-muxer=gif --disable-encoders --enable-encoder=aac --enable-encoder=libx264 --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=gif --enable-swscale --disable-filters --enable-filter=crop --enable-filter=scale --enable-filter=afade --enable-filter=atempo --enable-filter=copy --enable-filter=aformat --enable-filter=overlay --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=volume --enable-filter=rotate --enable-filter=apad --enable-filter=amerge --enable-filter=aresample --enable-filter=setpts --enable-filter=fps --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=trim --enable-filter=null --enable-filter=overlay --enable-filter=format --enable-filter=atrim --enable-filter=split --enable-filter=amix --enable-filter=anull --enable-filter=adelay --enable-gpl --enable-zlib --enable-libx264 --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --enable-decoder=mpeg4_mediacodec --enable-decoder=vp9_mediacodec --enable-decoder=vp8_mediacodec --enable-decoder=hevc_mediacodec --enable-hwaccels --enable-asm --enable-version3 --disable-doc --enable-neon"

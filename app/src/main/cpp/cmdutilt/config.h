...
#define FFMPEG_CONFIGURATION "--enable-libx264 --target-os=linux --arch=arm --enable-cross-compile --cross-prefix=arm-linux-androideabi- --sysroot=/Users/luoye/Git/GitLab/FFmpeg-Android-build/tmp/vplayer/sysroot/ --enable-static --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=pipe --enable-protocol=concat --disable-parsers --enable-parser=h264 --enable-parser=aac --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=aac --enable-demuxer=mpegts --disable-decoders --enable-decoder=aac --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=png --disable-muxers --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=mp3 --enable-muxer=mpegts --disable-encoders --enable-encoder=aac --enable-encoder=libx264 --enable-encoder=png --enable-gpl --enable-network --enable-swscale --enable-hwaccels --enable-avfilter --enable-asm --enable-version3 --prefix=/Users/luoye/Git/GitLab/FFmpeg-Android-build/build/ffmpeg/armv7 --extra-cflags='-O3 -Wall -mthumb -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -D__ARM_ARCH_5__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5TE__ -DANDROID -DNDEBUG -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -I/Users/luoye/Git/GitLab/FFmpeg-Android-build/build/x264/armv7/include' --extra-ldflags='-Wl,--fix-cortex-a8 -L/Users/luoye/Git/GitLab/FFmpeg-Android-build/build/x264/armv7/lib -lx264'"

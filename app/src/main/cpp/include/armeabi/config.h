...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=/Users/luoye/Git/GitLab/ffmpeg-android-build/build/ffmpeg/android/armeabi --enable-small --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/Users/luoye/Downloads/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/Users/luoye/Downloads/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --nm=/Users/luoye/Downloads/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-nm --extra-cflags=-I/Users/luoye/Git/GitLab/ffmpeg-android-build/build/x264/android/arm/include --extra-ldflags=-L/Users/luoye/Git/GitLab/ffmpeg-android-build/build/x264/android/arm/lib --sysroot=/Users/luoye/Downloads/android-ndk-r14b/platforms/android-14/arch-arm/ --extra-cflags=' -O3 -fpic -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=vfp -marm -march=armv6 -DHAVE_ISNAN -DHAVE_ISINF' --extra-ldflags='-lx264 -Wl,-rpath-link=/Users/luoye/Downloads/android-ndk-r14b/platforms/android-14/arch-arm//usr/lib -L/Users/luoye/Downloads/android-ndk-r14b/platforms/android-14/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog' --enable-static --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=concat --disable-parsers --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=image2 --enable-demuxer=gif --disable-decoders --enable-decoder=aac --enable-decoder=png --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=gif --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=mp3 --enable-muxer=ipod --enable-muxer=gif --disable-encoders --enable-encoder=aac --enable-encoder=libx264 --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=gif --enable-swscale --disable-filters --enable-filter=crop --enable-filter=scale --enable-filter=afade --enable-filter=copy --enable-filter=aformat --enable-filter=overlay --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=volume --enable-filter=rotate --enable-filter=apad --enable-filter=amerge --enable-filter=aresample --enable-filter=setpts --enable-filter=fps --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=trim --enable-filter=null --enable-filter=overlay --enable-filter=format --enable-filter=atrim --enable-filter=split --enable-filter=amix --enable-filter=anull --enable-gpl --enable-zlib --enable-libx264 --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --enable-hwaccels --enable-asm --enable-version3 --disable-doc --enable-neon"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/luoye/Git/GitLab/ffmpeg-android-build/build/ffmpeg/android/armeabi/share/ffmpeg"
#define AVCONV_DATADIR "/Users/luoye/Git/GitLab/ffmpeg-android-build/build/ffmpeg/android/armeabi/share/ffmpeg"
